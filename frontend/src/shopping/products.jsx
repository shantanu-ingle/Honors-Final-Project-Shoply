...
export default function Products() {
    ...
    return (
        ...
        {loading && <div style={{ fontSize: "1.5em", color: "blue" }}>Loading...</div>}
    
        {!loading && response.length > 0 && !ordered &&
            <Row md={2} style={{ rowGap: "1rem" }}>
                {response.map(p => {
                    return (<ProductItem product={p} onAddCart={addToCart} key={p._id} style={{ width: "300px", backgroundColor: "#f0f0f0", padding: "1em", borderRadius: "10px" }} />)
                })}
            </Row>
        }
        ...
        {!loading && !ordered && 
            <div className="row justify-content-center" style={{ marginTop: "1rem" }}>
                <div className="col col-2" style={{ backgroundColor: "#f0f0f0", padding: "1em", borderRadius: "10px" }}>
                    <b>Total: {sum}</b>&nbsp;
        ...
        {ordered && 
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col col-6 text-center" style={{ backgroundColor: "#f0f0f0", padding: "2em", borderRadius: "10px" }}>
